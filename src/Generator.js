...
export default class Generator extends React.Component {
  ...
  render(){
    ...
    return (
      <div>
        <h2>The avarage rating is {this.calcAvarageRating(movies)}!</h2>
        <button id='generate-bt' onClick={this.addToGenerator}>Generate Random Movie</button>
            ...
            movies.map(movie =>{
              return(
                <div key={movie.id} className='movie-block'>
                  ...
                  <p id='movie-name'>{movie.name }({"\u2724".repeat(movie.rating)})</p>
